...
public class DecalManager extends MonoBehaviour {
	...
	function drawDecal (l_Ray : Ray, l_Camera : Camera) {
			...
			if (Physics.Raycast (l_Ray, l_RaycastHit, Mathf.Infinity)) {
				...
				var l_ForwardDirection = l_Camera.transform.up;
				var l_UpDirection = - l_Camera.transform.forward;
